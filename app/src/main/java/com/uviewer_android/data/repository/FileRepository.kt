...
class FileRepository {
    ...
    private fun mapToFileEntry(file: File): FileEntry {
        ...
        val type = when {
            ...
            extension in FileEntry.IMAGE_EXTENSIONS -> FileEntry.FileType.IMAGE
            extension in listOf("txt", "md", "aozora", "csv", "log", "json") -> FileEntry.FileType.TEXT
            ...
            extension in listOf("rar", "cbr") -> FileEntry.FileType.RAR
            extension in listOf("7z", "cb7") -> FileEntry.FileType.SEVEN_ZIP
